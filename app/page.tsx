    ...
    <div className="min-h-screen w-full bg-[#0b0e14] text-white flex flex-col font-sans">
      ...
      <nav className="w-full py-5 px-10 flex justify-between items-center border-b border-white/5 bg-[#0b0e14]/80 backdrop-blur-md fixed top-0 z-50">
        <Link href="/" className="flex items-center gap-3">
          <Image src="/icon.png" alt="Logo" width={35} height={35} className="rounded-full shadow-lg shadow-blue-500/20" />
        ...
        <div className="flex gap-8 items-center">
          ...
          <Link href="/feed" className="text-[10px] font-bold uppercase tracking-widest text-blue-400 hover:text-blue-300 transition-all italic underline decoration-blue-500/30 underline-offset-4">Communauté</Link>
