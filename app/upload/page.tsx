    ...
    <div className="min-h-screen w-full bg-[#0b0e14] text-white flex flex-col font-sans">
      ...
      <nav className="w-full py-5 px-10 flex justify-between items-center border-b border-white/5 bg-[#0b0e14]/80 backdrop-blur-md fixed top-0 z-50">
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="text-xl font-black italic text-blue-600 tracking-tighter uppercase text-blue-600">DEVSTEP</span>
        </Link>

        <div className="flex gap-8 items-center">
          <Link href="/" className="text-[10px] font-bold uppercase tracking-widest hover:text-blue-500 transition-all">Accueil</Link>
          
          {/* LE LIEN MAGIQUE VERS LE FEED */}
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 mt-32 text-center">
        ...
        <div className="max-w-2xl mb-16 px-10 py-12 border border-white/5 bg-white/[0.01] rounded-[50px] backdrop-blur-sm">
          <h2 className="text-xl md:text-2xl font-medium text-gray-300 italic">
        ...
        <div className="flex flex-col sm:flex-row gap-6 w-full max-w-md pb-24">
          <Link href="/upload" className="flex-1 py-5 bg-blue-600 hover:bg-blue-700 rounded-2xl font-black text-xs uppercase tracking-widest transition-all hover:scale-105">Héberger</Link>
          <Link href="/login" className="flex-1 py-5 bg-[#1a1f2b] border border-white/10 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-[#252c3d] transition-all hover:scale-105">Se Connecter</Link>
        </div>

        {/* SECTION DONS */}
        <div id="donations" className="max-w-4xl w-full mb-16 grid grid-cols-1 md:grid-cols-2 gap-6 px-4">
          <div className="p-10 border border-red-500/20 bg-red-500/[0.02] rounded-[45px] flex flex-col items-center group">
          ...
          <div className="p-10 border border-blue-500/20 bg-blue-500/[0.02] rounded-[45px] flex flex-col items-center">
            ...
            <p className="text-gray-400 text-[11px] mb-6 italic text-center">Via Taptap Send ou WorldRemit</p>
            <div className="w-full p-4 bg-white/[0.03] rounded-2xl border border-white/5 text-sm font-mono font-bold text-center">+243 995 909 060</div>
          </div>
        </div>
      </main>
